...
const updateUrl = "http://localhost:3000/admin/users/update";
const viewUrl = "http://localhost:3000/admin/users/view";
window.addEventListener("DOMContentLoaded",()=>{
    ...
    .then(res=>{
            ...
            res.forEach(el=>{
                ...
                td2.innerHTML = el["username"];

                const td3 = document.createElement("td");
                td3.innerHTML = el["email"];

                const td4 = document.createElement("td");
                td4.innerHTML = el["is_admin"];
