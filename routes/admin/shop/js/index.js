...
const updateUrl = "http://localhost:3000/admin/shops/update";
const viewUrl = "http://localhost:3000/admin/shops/view";
window.addEventListener("DOMContentLoaded",()=>{
    ...
    .then(res=>{
            ...
            res.forEach(el=>{
                ...
                td2.innerHTML = el["location"];

                const td3 = document.createElement("td");
                td3.innerHTML = el["name"];

                const td4 = document.createElement("td");
                td4.innerHTML = el["revenue"] + "$";
                ...
                const tdNumberOfEmployees = document.createElement("td");
                tdNumberOfEmployees.innerHTML = el["numberOfEmployees"];
                ...
                row.appendChild(td3);
                row.appendChild(td4);
                row.appendChild(tdNumberOfEmployees);
                row.appendChild(td5);
                row.appendChild(td6);
